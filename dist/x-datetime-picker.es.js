      ...
      createElementVNode("table", null, [
        createElementVNode("thead", null, [
          createElementVNode("tr", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($options.getWeekFormat, (name, index) => {
        ...
        createElementVNode("tbody", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.getMonthDays(), (group, index) => {
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$4, [
    ...
    createElementVNode("div", _hoisted_5$2, [
      createElementVNode("table", null, [
        createElementVNode("tbody", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.years, (group, index) => {
            return openBlock(), createElementBlock("tr", {
              key: `year-${index}`
            }, [
...
var XYear = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4]]);
const _sfc_main$3 = {
  name: "XMonth",
  created() {
    this.getMonths();
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$3, [
    ...
    createElementVNode("div", _hoisted_6$1, [
      createElementVNode("table", null, [
        createElementVNode("tbody", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($data.months, (group, index) => {
            return openBlock(), createElementBlock("tr", {
              key: `month-${index}`
            }, [
...
var XMonth = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3]]);
const _sfc_main$2 = {
  name: "XTime",
  created() {
    if (this.useHMS) {
  ...
  methods: {
    ...
    selectTime() {
      if (!Number.isNaN(this.curHour) && !Number.isNaN(this.curMinute) && !Number.isNaN(this.curSecond)) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$2, [
    ...
    createElementVNode("div", _hoisted_5, [
      createElementVNode("div", null, [
        createElementVNode("ul", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.hours, (value, index) => {
      ...
      createElementVNode("div", null, [
        createElementVNode("ul", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.minutes, (value, index) => {
            return openBlock(), createElementBlock("li", {
              key: `minute-${index}`
            }, [
              createElementVNode("div", {
      ...
      $props.useHMS === "second" ? (openBlock(), createElementBlock("div", _hoisted_8, [
        createElementVNode("ul", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($options.seconds, (value, index) => {
            return openBlock(), createElementBlock("li", {
              key: `second-${index}`
            }, [
              createElementVNode("div", {
                ...
                onClick: _cache[3] || (_cache[3] = withModifiers((...args) => $options.selectSecond && $options.selectSecond(...args), ["stop"]))
    ...
    !$props.popoverHMS ? (openBlock(), createElementBlock("div", _hoisted_10, [
      createElementVNode("button", {
        onClick: _cache[4] || (_cache[4] = (...args) => $options.cancelTime && $options.cancelTime(...args))
      }, "cancel"),
      createElementVNode("button", {
        onClick: _cache[5] || (_cache[5] = (...args) => $options.selectTime && $options.selectTime(...args))
      }, "ok")
    ])) : createCommentVNode("", true)
  ]);
}
              ...
              switch (this.chooseSpan) {
                ...
                default:
                  if (this.chooseSpan && !Number.isNaN(Number(this.chooseSpan))) {
                    if (data.position === "begin") {
                      curEnd = moment(useDatetime).startOf("day").add(this.chooseSpan, "seconds").format(this.getDateFormat);
                      ...
                      curBegin = moment(useDatetime).endOf("day").subtract(this.chooseSpan, "seconds").format(this.getDateFormat);
                      if (this.limit && this.limit.begin && moment(curBegin).isBefore(this.limit.begin)) {
